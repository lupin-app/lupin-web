...
export declare const createTriggerEvaluator: (groupedLabeledEvents: ReturnType<typeof groupLabeledEventIdsByEventType>, labeledEventToTriggerMap: ReturnType<typeof createLabeledEventToTriggerMap>, dataExtractor: DataExtractor, options: ElementInteractionsOptions) => TriggerEvaluator;
