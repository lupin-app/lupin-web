...
export declare class DataExtractor {
    ...
    addTypeAndTimestamp: <T>(event: T, type: BaseTimestampedEvent<T>["type"] | ElementBasedTimestampedEvent<T>["type"]) => BaseTimestampedEvent<T> | ElementBasedTimestampedEvent<T>;
    addAdditionalEventProperties: <T>(event: T, type: TimestampedEvent<T>["type"], selectorAllowlist: string[], dataAttributePrefix: string, isCapturingCursorPointer?: boolean) => TimestampedEvent<T> | ElementBasedTimestampedEvent<T>;
